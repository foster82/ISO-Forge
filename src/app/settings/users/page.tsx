...
import { ArrowLeft, Users, HardDrive, Shield, Globe } from 'lucide-react'
      ...
      <header className="bg-white border-b border-slate-200 px-6 py-4">
        <div className="flex items-center justify-between max-w-6xl mx-auto w-full">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold text-slate-900">User Usage & Quotas</h1>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full p-6 space-y-6">
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
          <div className="p-6 border-b border-slate-200 bg-slate-50/50">
            ...
            <p className="text-xs text-slate-500 mt-1">Breakdown of disk space used by each user's completed builds.</p>
          </div>
